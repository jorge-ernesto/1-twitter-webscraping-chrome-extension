...
function functionToInject() {
    ...
    function agregarBotones() {
        ...
        if (navElement) {
            ...
            navElement.append(buttonObtenerData, buttonDescargarImagenes);
    ...
    if (!document.getElementById('obtener-data') && !document.getElementById('descargar-imagenes')) {
        agregarBotones();
    }
    ...
    document.getElementById('obtener-data').addEventListener('click', () => {
        obtenerPosts();
        realizarScroll();
